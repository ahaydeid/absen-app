    ...
    <div className="min-h-screen bg-white flex flex-col items-center px-4 pb-20">
      <div className="w-full max-w-md mt-3">
        ...
        <div className="flex flex-col gap-3 mb-4">
          ...
          <button className="bg-yellow-400 text-gray-900 font-semibold text-lg rounded-xl py-3 shadow">
            Nilai Harian
          </button>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-3 space-y-3">
          {sections.map((sec, i) => (
            <div
              key={i}
              className={`rounded-xl p-3 ${sec.style} shadow-sm`}
            >
              <h3
                className={`text-center text-base mb-2 ${sec.titleStyle}`}
              >
                {sec.title}
              </h3>
