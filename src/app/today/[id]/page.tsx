...
export default function TodayPage() {
  ...
  const [loading, setLoading] = useState<boolean>(!!id); // only loading if id provided
            ...
            <div className="w-full max-w-full">
              <div className="flex w-full items-center gap-3">
                <div className="flex-1">
                  <h2 className="text-xl font-bold text-white"><span className="bg-sky-500 rounded p-1">{card.kode}</span></h2>
