            ...
            {loading ? (
              ...
              mapel.map((m, idx) => (
                <tr key={m.id} className="hover:bg-gray-50 transition-colors border-b">
                  ...
                  <td className="px-4 py-3">{Array.isArray(m.guru) ? m.guru[0]?.nama || "-" : m.guru?.nama || "-"}</td>
      ...
      <div className="flex justify-between items-center mt-4 text-sm">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={page === 1}
            // PERUBAHAN UI: Tombol bulat dengan ikon panah
          ...
          <span className="px-3 py-1 text-gray-600 rounded-md font-semibold">
            {/* LOGIKA ASLI TETAP: {page} / {totalPages || 1} */}
            {page} / {totalPages || 1}
          </span>
